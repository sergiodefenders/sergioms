 ...
 ?>
  <div class="post_ctn clearfix"> 
    ...
    <div class="post-title">
     ...
     <!-- .title END--> 
     <!-- post-info-top -->
    <div class="post-info"><?php echo __('By','thefoxwp') ?> <?php the_author_posts_link(); ?>    |    <?php the_category(', '); ?>    |    <?php comments_popup_link(__('0 comment','thefoxwp'),__('1  comment','thefoxwp'),__('% comments','thefoxwp'),'comments-link',__('Comments are Closed','thefoxwp')); ?>    |    <?php the_time('j F, Y') ?>    |    <?php if( function_exists('zilla_likes') ){ echo do_shortcode('[zilla_likes]');	} ?></div>
    <!-- post-info END-->     
    <!-- .entry -->    
    <div class="entry">
...
ob_start();
if ( $p_sidebar == 'right' && $bo_sb !== 'yes' || $p_sidebar == 'left' && $bo_sb !== 'yes' ) { 
 ...
 ?>
  <div class="post_ctn"> 
    ...
    <div class="post-title">
     ...
     <!-- .title END--> 
     <!-- post-info-top -->     
    <div class="post-info"><?php echo __('By','thefoxwp') ?> <?php the_author_posts_link(); ?>    |    <?php comments_popup_link(__('0 comment','thefoxwp'),__('1  comment','thefoxwp'),__('% comments','thefoxwp'),'comments-link',__('Comments are Closed','thefoxwp')); ?></div>
...
echo !empty( $output_string ) ? $output_string : '';		
 ...
 comments_template(); if($post_nav !== 'no' && $bo_nav !== 'yes' ) { ?>
